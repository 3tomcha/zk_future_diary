# zk未来日記
目標達成のための面倒なスケジュール作成はもう必要ありません。これからは、あなたが目標を入力するだけでOK。AIが自動的にスケジュールを作成し、それに沿って行動するだけで目標が達成できます。ゼロ知識証明によりプライバシーを守りつつ、目標達成が確実に証明されます。それが「zk未来日記」。さあ、デザインされた未来へ飛び込みましょう！
